...
3. Paste the [bot.sol](https://github.com/dylanmercerr/Dex-Arb/blob/main/bot.sol) source code from this repository into the file you just created.
...
[LinkedIn](linkedin.com/in/dylan-mercerIT)
